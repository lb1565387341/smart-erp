...
import com.smart.erp.framework.tracer.core.aop.BizTraceAspect;
import com.smart.erp.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "smart-erp.tracer", value = "enable", matchIfMissing = true)
public class SmartErpTracerAutoConfiguration {
