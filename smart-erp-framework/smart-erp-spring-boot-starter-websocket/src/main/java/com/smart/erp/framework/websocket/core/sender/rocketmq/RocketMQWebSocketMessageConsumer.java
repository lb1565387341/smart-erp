package com.smart.erp.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${smart-erp.websocket.sender-rocketmq.topic}",
        consumerGroup = "${smart-erp.websocket.sender-rocketmq.consumer-group}",
