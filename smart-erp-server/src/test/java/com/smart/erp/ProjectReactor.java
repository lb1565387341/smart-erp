...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.smart.erp.boot";
    private static final String ARTIFACT_ID = "SmartErp";
    private static final String PACKAGE_NAME = "com.smart.erp";
    private static final String TITLE = "智慧ERP系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.smart.erp.boot";
        String artifactIdNew = "SmartErp";
        String packageNameNew = "com.smart.erp";
        String titleNew = "智慧ERP系统";
