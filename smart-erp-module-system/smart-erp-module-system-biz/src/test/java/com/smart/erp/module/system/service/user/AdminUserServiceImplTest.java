package com.smart.erp.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.smart.erp.framework.common.enums.CommonStatusEnum;
import com.smart.erp.framework.common.exception.ServiceException;
import com.smart.erp.framework.common.pojo.PageResult;
import com.smart.erp.framework.common.util.collection.ArrayUtils;
import com.smart.erp.framework.common.util.collection.CollectionUtils;
import com.smart.erp.framework.test.core.ut.BaseDbUnitTest;
import com.smart.erp.module.infra.api.config.ConfigApi;
import com.smart.erp.module.infra.api.file.FileApi;
import com.smart.erp.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.smart.erp.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.smart.erp.module.system.controller.admin.user.vo.user.*;
import com.smart.erp.module.system.dal.dataobject.dept.DeptDO;
import com.smart.erp.module.system.dal.dataobject.dept.PostDO;
import com.smart.erp.module.system.dal.dataobject.dept.UserPostDO;
import com.smart.erp.module.system.dal.dataobject.tenant.TenantDO;
import com.smart.erp.module.system.dal.dataobject.user.AdminUserDO;
import com.smart.erp.module.system.dal.mysql.dept.UserPostMapper;
import com.smart.erp.module.system.dal.mysql.user.AdminUserMapper;
import com.smart.erp.module.system.enums.common.SexEnum;
import com.smart.erp.module.system.service.dept.DeptService;
import com.smart.erp.module.system.service.dept.PostService;
import com.smart.erp.module.system.service.permission.PermissionService;
import com.smart.erp.module.system.service.tenant.TenantService;
...
import static com.smart.erp.framework.common.util.collection.SetUtils.asSet;
import static com.smart.erp.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.smart.erp.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.smart.erp.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.smart.erp.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.smart.erp.framework.test.core.util.AssertUtils.assertServiceException;
import static com.smart.erp.framework.test.core.util.RandomUtils.*;
import static com.smart.erp.module.system.enums.ErrorCodeConstants.*;
import static com.smart.erp.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("SmartErpyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("SmartErpyuanma");
        ...
        assertEquals("SmartErpyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("SmartErpyuanma"))).thenReturn("java");
