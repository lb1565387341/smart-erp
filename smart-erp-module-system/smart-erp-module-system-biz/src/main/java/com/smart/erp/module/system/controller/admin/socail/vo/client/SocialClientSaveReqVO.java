package com.smart.erp.module.system.controller.admin.socail.vo.client;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "SmartErp商城")
