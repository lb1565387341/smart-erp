package com.smart.erp.module.infra.service.codegen.inner;
...
import com.smart.erp.framework.apilog.core.enums.OperateTypeEnum;
...
import com.smart.erp.framework.common.util.date.LocalDateTimeUtils;
import com.smart.erp.framework.common.util.object.BeanUtils;
import com.smart.erp.framework.common.util.object.ObjectUtils;
import com.smart.erp.framework.common.util.string.StrUtils;
import com.smart.erp.framework.excel.core.annotations.DictFormat;
import com.smart.erp.framework.excel.core.convert.DictConvert;
import com.smart.erp.framework.excel.core.util.ExcelUtils;
import com.smart.erp.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "SmartErp-module-${table.moduleName}/" + // 顶级模块
                "SmartErp-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "SmartErp-module-${table.moduleName}/" + // 顶级模块
                "SmartErp-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "SmartErp-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "SmartErp-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
