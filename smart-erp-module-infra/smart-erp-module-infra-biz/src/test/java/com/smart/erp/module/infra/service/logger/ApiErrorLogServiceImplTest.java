package com.smart.erp.module.infra.service.logger;
...
import com.smart.erp.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.smart.erp.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.smart.erp.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.smart.erp.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.smart.erp.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.smart.erp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.smart.erp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("SmartErp-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("SmartErp-test");
